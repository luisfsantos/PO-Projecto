...
*@see arabiannights.FriendlyGenie
*@see arabiannights.GrumpyGenie
*@see arabiannights.RecyclableDemon
*/
public abstract class Genie {
	...
	*@param wishes Recebe o nu'mero de desejos que pode realizar e ignora
	*_wishesGranted.
	*/
